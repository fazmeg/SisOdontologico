...
<page style="font-size: 10pt">
    ...
    <table style="width: 50%;border: solid 3px #5544DD" align="center">
        <tr>
            ...
            <td style="width: 40%; text-align: center;"><img src="../../../html2pdf_v4.03/examples/res/res/logo.gif" alt="" ><br><i>légende</i></td>
    ...
    texte à la suite d'une image, <img src="../../../html2pdf_v4.03/examples/res/res/logo.gif" alt="" style="height: 10mm">
