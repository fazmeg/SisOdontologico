...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
    ...
    <div style="text-align: center; width: 100%;">
        <br>
        <img src="../../../html2pdf_v4.03/examples/res/res/logo.png" alt="Logo HTML2PDF" style="width: 150mm">
        <br>
    </div>
    <br><br><br><br><br>
    <div class="note">
...
<page pageset="old">
    ...
    <ul class="main">
        ...
        <li>&lt;img&gt; : <img src="../../../html2pdf_v4.03/examples/res/res/tcpdf_logo.jpg" style="width: 10mm"></li>
