...
<page style="font-size: 14px">
    ...
    <br>
    Image : <img src="../../../html2pdf_v4.03/examples/res/res/logo.gif" alt="Logo" width=150 /><br>
    <br>
                    ...
                    <tr>
                        ...
                        <td style="border: solid 2px #000077; padding: 2mm">
                            <table style="border: solid 1px #445500">
                                <tr>
                                    <td>
                                        <img src="../../../html2pdf_v4.03/examples/res/res/logo.gif" alt="Logo" width=100 />
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <table style="border: solid 5mm #770000; padding: 5mm;" cellspacing="0" >
        <tr>
            <td style="border: solid 3mm #007700; padding: 2mm;"><img src="../../../html2pdf_v4.03/examples/res/res/off.png" alt="" style="width: 20mm"></td>
        </tr>
    </table>
    <img src="../../../html2pdf_v4.03/examples/res/res/off.png" style="width: 10mm;"><img src="../../../html2pdf_v4.03/examples/res/res/off.png" style="width: 10mm;"><img src="../../../html2pdf_v4.03/examples/res/res/off.png" style="width: 10mm;"><img src="../../../html2pdf_v4.03/examples/res/res/off.png" style="width: 10mm;"><img src="../../../html2pdf_v4.03/examples/res/res/off.png" style="width: 10mm;"><br>
    <br>
