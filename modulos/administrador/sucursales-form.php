			...
			<div class="control-group well">
				<form class="form-horizontal" method="post" action="<?php echo $RUTAm; ?>administrador/funciones/sucursales-fncs.php" onSubmit="return verificarSuc()">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-block-level" id="suc_ciudad" name="suc_ciudad" value="<?php echo $datSuc['suc_ciudad']; ?>" placeholder="Ciudad" required>
						</div> 
					</div>
					<div class="control-group">
						<label class="control-label">Código Postal</label>
						<div class="controls">
							<input type="text" class="input-block-level" id="suc_postal" name="suc_postal" value="<?php echo $datSuc['suc_postal']; ?>" placeholder="Código Postal" required>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Teléfono</label>
						<div class="controls">
							<input type="text" class="input-block-level" id="suc_telefono" name="suc_telefono" value="<?php echo $datSuc['suc_telefono']; ?>" placeholder="Teléfono" required>
						</div> 
					</div>
