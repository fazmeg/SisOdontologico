<?php 
	...
	$mail->Username = 'info@odontoclinic.ec';                    // Usuario de SMTP
	$mail->Password = 'ecuaodonted';                           	// Contraseña de usuario SMTP 
	$mail->SMTPSecure = '';                            			// Habilitar el cifrado, 'ssl' y 'tls'
	$mail->Port = 2525; 
	$mail->From = 'info@odontoclinic.ec';
	...
	header("Location: ".$RUTAm."correo/index.php");	
